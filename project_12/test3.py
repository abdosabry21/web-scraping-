...
cookies = {
    ...
    'ASP.NET_SessionId': 'oc0dgpspqlpszjjcgrtspy0i',
    'saxo_cart_is_empty': 'yes',
    '_gcl_au': '1.1.1565188550.1700306338',
    'CookieConsent': '{stamp:%27XG6MinD1LSh34P9kNcPr5TBGbXFVWCCXb32f1pYaBRoRoxR/UfKbgw==%27%2Cnecessary:true%2Cpreferences:true%2Cstatistics:true%2Cmarketing:true%2Cmethod:%27explicit%27%2Cver:1%2Cutc:1700306338950%2Cregion:%27eg%27}',
    '_ga_MXLY381H2N': 'GS1.1.1700306340.1.1.1700306903.0.0.0',
    '_ga': 'GA1.1.2137141065.1700306341',
    '_pk_id.4.7785': 'f5a5b0eca1c88e1b.1700306341.',
    '_pk_ses.4.7785': '1',
    '__exponea_etc__': '1052b893-cb68-4654-8412-00bca5ede5c7',
    '__exponea_time2__': '-0.9561388492584229',
    '_fbp': 'fb.1.1700306342050.1513110190',
    'BIGipServer~saxo~pool-saxo-https': '1359472138.47873.0000',
    'saxo_rsc': 'eF5jYSlN9kg0SrYwSzNO1U0xMzTRNTFNSdG1SEuz0E01NjNKs7BIMjNNtODKLSvJTOEzNTTWNdQ1BACY8Q54',
    '_uetsid': '46a1f870860411ee93deb92ca57df0ab',
    '_uetvid': '46a22a80860411eeb994897db332c227',
}
...
response = requests.post('https://www.saxo.com/dk/bestsellers/filter', cookies=cookies, headers=headers, json=json_data)
